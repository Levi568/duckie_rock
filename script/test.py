...
class mp3_color_line():
    def __init__(self):
        ...
        self.sub_image = rospy.Subscriber("usb_cam/image_raw/compressed", CompressedImage, self.lane_filter, queue_size=1)
    ...
    def lane_filter(self,image):
        ...
        np_arr = np.fromstring(image.data, dtype=np.uint8)
